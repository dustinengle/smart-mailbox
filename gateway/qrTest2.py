...
class Gateway(Frame):
    ...
    def startScreen(self):
        ...
        #self.kit = mp.Process(target=lambda: self.kit_start(pw))
        self.kit_setup(pw)
        self.pw = pw
    ...
    def scan_mailbox(self,boxNum):
        ...
        print 'box: ' + str(boxNum) + ', check: ' + str(self.mailbox_check())
    ...
    def sensor_setup(self):
        ...
        sensor = mp.Process(target=lambda: self.sensor_start())
        sensor.start()
    ...
    def sensor_start(self,boxNum):
        print('sensor_start')
        os.system('python safebox/mailbox.py '+str(boxNum))
        return 0
